...
#Function to Adding new contact to ContactList
def AddContact():
...
#Function to Delete an Entry from the ContactList
def DeleteEntry():
    if len(select.curselection()) != 0:
...
Button(root,text="DELETE", font='Helvetica 18 bold',bg='#e8c1c7',command = DeleteEntry, padx=20).place(x= 50, y=260)
